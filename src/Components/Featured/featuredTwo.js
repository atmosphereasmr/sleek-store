...
export default class FeaturedTwo extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            items: [],
            chosenTitle: "Men's New Rock Boots",
            chosenDesc: "You can never have enough gear, can you? This heavy-on-metal pair of gothic boots from world-famous New Rock footwear company is loaded with studs, spikes and everything extreme. Featuring seven stud and spike covered adjustable straps wrapping from the vamp all the way up the shaft, these boots should come with a warning label! Masterfully crafted of strong materials and made for a lifetime of motorcycling, partying and concert-going. It doesn't get much more badass than this!",
            price: "$348.99",
            specs: "Made of leather and durable natural rubber. Price of boots may depend upon size.",
            link: "http://amzn.to/2GDXwB1",
            url: "https://images-na.ssl-images-amazon.com/images/I/61MUwhuSyLL._UY575_.jpg"
        }
    }
