...
export default class FeaturedThree extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            items: [],
            chosenTitle: "Summitfashions Women's Lace Up",
            chosenDesc: "A sleek pair of boots that are laced up from the tip of the toe to the height of the cuff! This sexy pair of women's gothic boots from Summitfashions alternative clothing company are made of 100% synthetic materials and built to last a lifetime of fun, danger and extreme entertainment. Boasting a tall, sturdy natural rubber heel and six adjustable buckle straps, they are the perfect pair of boots for going to the dance club, party or industrial concerts. Be ready to turn some heads and never be forgotten!",
            price: "$97.98",
            specs: "Available in sizes 7 US through 12 US. Crafted of durable 100% synthetic, animal-cruelty free materials. Price of boots may vary depending upon size selected.",
            link: "http://amzn.to/2Fq4sSW",
            url: "https://images-na.ssl-images-amazon.com/images/I/6119DsGM59L._UY575_.jpg"
        }
    }
