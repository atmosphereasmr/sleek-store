...
export default class WomensShoes extends Component {

    componentDidMount() {
        const MensShoes = require('../../Data/womens-shoes')
        this.setState({ items: MensShoes.data }, () => console.log(this.state.items))
        const tab = document.getElementById('womens-shoes')
        const tab2 = document.getElementById('mens-boots')
        const tab3 = document.getElementById('mens-shoes')
